...
* TODO Einleitung label:sec-einleitung                               :ignore:
...
#+name: eq-helmholtz
\begin{equation}
B = (\frac{4}{5})^{\frac{3}{2}} \cdot \mu_{\mathrm{0}} \cdot \frac{N \cdot I}{r}
\end{equation}
...
#+name:fig-ferro
#+attr_latex: :placement [H] :width 0.33\textwidth
#+caption: Schematische Darstellung der magnetischen Momente in einem ferromagnetischen Festkörper.
[[file:img/ferro.PNG]]
...
#+name:fig-antiferro
#+attr_latex: :placement [H] :width 0.33\textwidth
#+caption: Schematische Darstellung der magnetischen Momente in einem antiferromagnetischen Festkörper.
[[file:img/antiferro.PNG]]
...
#+name: img-aufbau
file:./img/aufbau1.jpg

#+caption: Partikeltransport Versuchsaufbau. ...
#+attr_latex: :width 0.5\textwidth
#+name: img-aufbau
file:./img/aufbau2.jpg
...
* TODO Ergebnisse und Diskussion                                     :ignore:
...
* TODO Diskussion und Ausblick                                       :ignore:


* TODO Zusammenfassung                                               :ignore:
