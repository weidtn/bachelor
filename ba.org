...
:END:
#+name: fig-betrag
#+caption: Betrag der Magnetfeldvektoren. Die angelegten Magnetfeldsequenzen sind in blau und orange dargestellt, der Betrag der Magnetfeldvektoren ist in grün dargestellt.
#+attr_latex: :width \textwidth :placement [h]
