...
* Fragen                                                             :ignore:
  - Drehimpuls im EB einfach weglassen?
* TODO [10/15] Noch zu tun:                                          :ignore:
...
#+name:fig-force_spp
#+caption: Schematische Darstellung der wirkenden Kräfte auf ein superparamagnetisches Partikel oberhalb des EB-Dünnschichtsystems. Zu sehen sind van-der-Waals-Kraft $F_\mathrm{vdw}$, elektrostatische Kraft $F_\mathrm{e}$ ,magnetostatische Kraft $F_\mathrm{m}$, Reibungskraft $F_\mathrm{R}$ und magnetische Kraft $F_\mathrm{M}$.
...
#+RESULTS:
: 0.043382473468657534
: 0.0551879417856036
: 0.0416841969595978
: 0.048972737947641565
...
#+begin_src python :session traj :results output
  ...
  t_005 = pd.read_csv("./Messung/800nmSi/1um_0,4_slope10.csv")   
  t_01 = pd.read_csv("./Messung/800nmSi/1um_0,4_slope4.csv")   
  t_015 = pd.read_csv("./Messung/800nmSi/1um_0,4_slope2,666.csv")   
  t_02 = pd.read_csv("./Messung/800nmSi/1um_0,4_slope2.csv")   
  t_025 = pd.read_csv("./Messung/800nmSi/1um_0,4_slope1,6.csv")   
