...
** TODO [2/5] Magnetismus in Materie label:sec-magnetismus
...
*** TODO Exchange Bias Effekt label:sec-EB
    Der Exchange Bias Effekt wurde 1956 von \textsc{Meiklejohn} und \textsc{Bean} an oxidierten \ce{Co}-Partikeln entdeckt cite:meiklejohn_new_1957.
