...
#+name: fig-mag_fit
#+caption: Zeitlicher Verlauf der magnetischen Flussdichte der z-Spule. Rot gestrichelt eingezeichnet ist die vorhergesagte Sättigungsflussdichte für gegebene Stromstärken.
#+attr_latex: :width 0.75\textwidth :placement [h]
