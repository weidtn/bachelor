...
#+attr_org: :width 100px
[[file:img/trapez.png]]
* Experimentelle Methoden label:sec-methoden
** Experimenteller Aufbau label:sec-aufbau
...
** Programm zur Erstellung von Magnetfeldsequenzen label:sec-py
...
** Zeitabhängige Messung von Strom und magnetischer Flussdichte label:sec-stromundmagnet
...
* Ergebnisse und Diskussion label:sec-ergebnisse
...
** Stromstärke und magnetische Flussdichte der Helmholtzspulen label:sec-b_helmholtz
...
\newpage
** Partikeltransport label:sec-partikelgeschwindigkeiten
...
* Zusammenfassung und Ausblick label:sec-zusammenfassung
...
#+name: list:code
#+caption: Python-Code des Skriptes zur Messung des zeitlichen Verlaufs der Stromstärke und Flussdichte.
