...
#+begin_src python :session einaus :results output :exports none
  ...
  plt.tight_layout()
  plt.savefig("./img/einschalten.png", dpi=300)
  ...
  axes[1].legend()
  plt.tight_layout()
  plt.savefig("./img/ausschalten.png", dpi=300)
  plt.close()
  "ausschalten.png"
#+end_src
...
#+begin_src python :session magnetfeld :exports none :results file
  ...
  plt.legend()
  plt.tight_layout()
  plt.savefig("./img/B(I).png", dpi=300)
  "./img/B(I).png"
#+end_src 
...
#+begin_src python :session magnetfeld :results file :export none
  ...
  plt.grid()
  plt.tight_layout()
  plt.savefig("./img/B_calc.png", dpi=300)
  plt.close()
  "./img/B_calc.png"
#+end_src
...
#+begin_src python :session strom :exports none :results output
  ...
  plt.tight_layout()
  plt.savefig("./img/strom.png", dpi=300)
  plt.close()
  "./img/strom.png"
#+end_src
...
#+begin_src python :session strom :results output
  ...
  plt.tight_layout()
  plt.savefig("./img/strom_avg.png", dpi=300)
  "./img/strom_avg.png"
...
#+begin_src python :session strom :results output
  ...
  ax[1,1].set_xlabel("Datenpunkte")
  plt.tight_layout()
  plt.savefig("./img/strom_anfang.png", dpi=300)
  plt.close()
...
#+begin_src python :session mag :results output
  ...
  # ax[1,1].set_xticks(np.arange(0,500000,step=150000))
  plt.tight_layout()
  plt.savefig("./img/mag.png", dpi=300)
  plt.close('all')
  "./img/mag.png"
#+end_src
...
#+begin_src python :session mag :results output
  ...
  # ax[0,0].set_xticks(np.arange(0,50000,15000))
  plt.tight_layout()
  plt.savefig("./img/mag_avg.png", dpi=300)
  plt.close()
  "./img/mag_avg.png"
#+end_src
...
#+begin_src python :session mag :results output
  ...
  ax[1,1].set_xlabel("Datenpunkte")
  plt.tight_layout()
  plt.savefig("./img/mag_anfang.png", dpi=300)
  plt.close()
  "./img/mag_anfang.png"
#+end_src
...
#+begin_src python :session mag :results output
  ...
  ax[0].set_title("z")
  plt.tight_layout()
  plt.savefig("./img/mag_fit.png", dpi=300)
  plt.close()
  "./img/mag_fit.png"
#+end_src
...
#+begin_src python :session plateau :results output
  ...
  plt.grid()
  plt.tight_layout()
  plt.savefig("./img/plateau.png", dpi=300)
  "./img/plateau.png"
#+end_src
...
#+begin_src python :session simulation :results output
  ...
  plt.tight_layout()
  plt.savefig("./img/sim.png", dpi=300)
  plt.close()
  "./img/sim.png"
#+end_src
...
#+begin_src python :session magnitude :results output
  ...
  plt.tight_layout()
  plt.savefig("./img/magnitude.png", dpi=300)
  plt.close()
  "./img/magnitude.png"
  #+end_src
