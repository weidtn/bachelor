...
Anhand des Verlaufs der Fitfunktionen und des $R^2$ Wertes, ist erkennbar, dass die entstehenden Magnetfelder nicht nur dem angenommenen Modell folgen. Es scheinen noch weitere Faktoren in die Erzeugung der Magnetfelder hinein zu wirken.
