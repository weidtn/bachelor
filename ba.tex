...
Bei der Messung des zeitlichen Verlaufs der magnetischen Flussdichte, wurde der Messkopf eines Teslameters auf dem Probentisch zwischen den Helmholtzspulen platziert. Das FM210 Teslameter der \emph{Projekt Elektronik GmbH} besitzt einen BNC-Anschluss, über welchen wiederum ein DAQ-Gerät an einem AI angeschlossen wurde, um den zeitlichen Verlauf der magnetischen Flussdichte aufzuzeichnen.
...
\chapter{Anhang}
\label{sec:org0347e95}
\section{Messwerte}
\label{sec:org282e32e}
\begin{table}[htbp]
\caption{\label{tab-B}
...
\chapter*{}
\label{sec:org1fbaa23}
\printbibliography
\chapter*{Danksagung}
\label{sec:orge7cbd4e}
Danke.
\chapter*{Eigenständigkeitserklärung}
\label{sec:org785eb75}
