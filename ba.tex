...
Da vor allem das Ein- und Ausschaltverhalten der Spulen von Interesse ist, wurde der Beginn der Perioden, in dem die Stromstärke auf das Maximum ansteigt, genauer betrachtet. Zu sehen sind diese in Abbildung \ref{fig-strom_anfang}.
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{img/strom_anfang.png}
\caption{\label{fig-strom_anfang}
Verlauf der Stromstärke kurz nach dem "Einschalten". Links Stromstärken der x-Spule, rechts der z-Spule.}
\end{figure}

\section{Partikelgeschwindigkeiten \label{sec-partikelgeschwindigkeiten}}
\label{sec:org0c62399}
\blindtext
...
\chapter*{}
\label{sec:org868e832}
\printbibliography

\chapter*{Danksagung}
\label{sec:orgefc270d}
Danke.
\end{document}