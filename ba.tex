...
Schematische Darstellung der wirkenden Kräfte auf ein superparamagnetisches Partikel oberhalb des EB-Dünnschichtsystems. Zu sehen sind van-der-Waals-Kraft \(F_\mathrm{vdw}\), elektrostatische Kraft \(F_\mathrm{e}\) ,magnetostatische Kraft \(F_\mathrm{m}\), Reibungskraft \(F_\mathrm{R}\) und magnetische Kraft \(F_\mathrm{M}\).}
\end{figure}
