...
\label{sec:org8442a9d}
\chapter{Anhang}
\label{sec:org8761d08}
\section{Messwerte}
\label{sec:org003e293}
\begin{table}[htbp]
\caption{\label{tab-B}
...
\end{minted}
\section*{}
\label{sec:org623c2ef}
\printbibliography

\chapter*{Danksagung}
\label{sec:org1a8753c}
Danke.
\end{document}