...
\begin{figure}[h]
\centering
\includegraphics[width=0.3\textwidth]{./img/magnitude.png}
...
\label{sec:orgf110cd4}
\chapter{Anhang}
\label{sec:org69b589e}
\section{Messwerte}
\label{sec:org64bfc46}
\begin{table}[htbp]
\caption{\label{tab-B}
...
\end{minted}
\section*{}
\label{sec:orgcd55667}
\printbibliography

\chapter*{Danksagung}
\label{sec:orgeb57e31}
Danke.

\chapter*{Eigenständigkeitserklärung}
\label{sec:org919f551}
Hiermit bestätige ich, dass ich die vorliegende Arbeit selbständig verfasst und keine anderen
als die angegebenen Hilfsmittel benutzt habe. Die Stellen der Arbeit, die dem Wortlaut
oder dem Sinn nach anderen Werken (dazu zählen auch Internetquellen) entnommen sind,
