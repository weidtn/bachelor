...
\label{sec:org83b4b95}
\chapter{Anhang}
\label{sec:org733b5aa}
\section{Messwerte}
\label{sec:orgc7e0bf0}
\begin{table}[htbp]
\caption{\label{tab-B}
...
\end{minted}
\section*{}
\label{sec:orga8b4550}
\printbibliography

\chapter*{Danksagung}
\label{sec:orgf0af5fd}
Danke.
\end{document}