...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{img/strom_fit_fixed.png}
\caption{\label{fig-stromfit_fixed}
Fitfunktion zu Gleichung \ref{eq-strom-spule} durch die gemessenen Stromstärken mit vorgegebenem Widerstand \(R\) und Induktiviät \(L\).}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{./img/mag_fit_fixed.png}
\caption{\label{fig-mag_fit_fixed}
Fixed}
\end{figure}

\section{Partikelgeschwindigkeiten \label{sec-partikelgeschwindigkeiten}}
\label{sec:org05e2291}
