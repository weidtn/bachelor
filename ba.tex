...
\begin{figure}[h]
\centering
\includegraphics[width=.75\textwidth]{./img/magnitude.png}
...
\chapter*{}
\label{sec:org7ff8303}
\printbibliography
\chapter*{Danksagung}
\label{sec:org822cd0a}
Danke.
\chapter*{Eigenständigkeitserklärung}
\label{sec:orge41c25c}
