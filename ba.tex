...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{img/strom.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=.75\textwidth]{img/strom_avg.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=.75\textwidth]{img/mag.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=.75\textwidth]{img/mag_avg.png}
...
Es ist deutlich erkennbar, dass niedrigere Änderungsraten des externen Magnetfeldes auch niedrigere Gleichgewichtsgeschwindigkeiten bewirken. 
\chapter{Zusammenfassung und Ausblick \label{sec-zusammenfassung}}
\label{sec:org8d5511b}
\chapter{Anhang}
\label{sec:org967de88}
\section{Messwerte}
\label{sec:orgd3fba1c}
\begin{table}[htbp]
\caption{\label{tab-B}
...
\end{minted}
\section*{}
\label{sec:org12e0987}
\printbibliography

\chapter*{Danksagung}
\label{sec:org04b5968}
Danke.
\end{document}